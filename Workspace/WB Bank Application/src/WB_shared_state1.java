...
public class WB_shared_state1 {
	
	private WB_shared_state mySharedObj;
	private String myThreadName;
	private double mySharedVariable1;
	private boolean accessing=false; // true a thread has a lock, false otherwise
	private int threadsWaiting=0; // number of waiting writers

// Constructor	
	
	WB_shared_state1(double SharedVariable1) {
		mySharedVariable1= SharedVariable1;
	}
...
//Attempt to aquire a lock
	...
	public synchronized String processInput(String myThreadName, String theInput) {
    		...
    		if (theInput.equalsIgnoreCase("Action1")) {
    			//Correct request
    			if (myThreadName.equals("WB_server_Threading1")) {
    				/*  Add 20 to the variable
    					
    				 */
    				mySharedVariable1  = mySharedVariable1  + 21;
