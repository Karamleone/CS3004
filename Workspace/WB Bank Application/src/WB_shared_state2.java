...
//Attempt to aquire a lock
    ...
    /* The processInput method */
		  ...
		  public synchronized String processInput(String myThreadName, String theInput) {
	    		...
	    		if (theInput.equalsIgnoreCase("Action2")) {
	    			//Correct request
	    			if (myThreadName.equals("WB_server_Threading1")) {
	    				/*  Add 20 to the variable
	    					
	    				 */
	    				mySharedVariable2  = mySharedVariable2  + 22;
	   				System.out.println(myThreadName + " made the SharedVariable " + mySharedVariable2 );
	    				theOutput = "Do WB completed.  Shared Variable now = " + mySharedVariable2 ;
	    			}
	    			else if (myThreadName.equals("WBServerThread2")) {
	    				/*	Subtract 5 from the variable
	    					
	    					*/
	       				mySharedVariable2  = mySharedVariable2  - 5;
